...
# count_up.py, fill_array.py, halt.py, print_r1.py — lesson programs are written
# in assembly language (.as files), not Python; no .py counterparts exist.
MISSING := \
    count_up.py \
    fill_array.py \
    halt.py \
...
index.md: $(PY_FILES)
	@{ \
	    printf '# Variable Role Analysis: vm\n\n'; \
